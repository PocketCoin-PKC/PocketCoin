 ...
 *
 *   // network
 *   CPocketcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://www.PocketCoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPocketcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CPocketcoinNetwork(UniValue objIn)
    {
...
// // can be under: PocketcoinNetwork
// //   -- signature requirements : Key1(User)
// class CPocketcoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == PocketcoinNetwork);
//     // }
